...
export default function FilterSection() {
  ...
  return (
    <div className="flex justify-between w-full gap-10 ">
      <div className="flex gap-6 items-center w-full max-w-[800px] justify-between laptop:w-max mobile:flex-col mobile:gap-3 mobile:place-items-start">
        <FilterContainer
          title="층수"
          options={[2, 3, 4]}
          unit="층"
      ...
      <div className="w-full max-w-[439px] flex justify-end items-center gap-2 laptop:hidden">
        <InfoCircle />
